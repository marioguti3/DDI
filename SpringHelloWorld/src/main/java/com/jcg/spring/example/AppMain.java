...
public class AppMain {
    ...
    // This Method Is Used To Load The Spring Bean Configuration File And Return The 'BeanFactory' Object<font></font>
    public static BeanFactory getBeanFactory() {
        beanFactoryObj = new XmlBeanFactory(new ClassPathResource("spring-beans.xml"));
        return beanFactoryObj;
    }

    // This Is The Main Method And In Here We Are Retrieving The Spring Bean via 'getBean()' Method<font></font>
